...
public class ServletControlador extends HttpServlet {
    ...
    private void insertarCliente(HttpServletRequest request, HttpServletResponse response)
        ...
        Cliente cliente = new Cliente(nombre, apellido, email, movil, saldo);
    ...
    private void modificarCliente(HttpServletRequest request, HttpServletResponse response)
        ...
        double saldo = saldoParam != null && !saldoParam.isEmpty() ? Double.parseDouble(saldoParam) : 0.0;
        
        Cliente cliente = new Cliente(idCliente, nombre, apellido, email, movil, saldo);
